...
const SPOTS_DATA = [
  ...
  },
  {
    ...
    name: '大象自然公園 (Elephant Nature Park, ENP)',
    name_en: 'Elephant Nature Park (ENP)',
    category: 'sightseeing',
    lat: 18.7865,
    lng: 98.9855,
    emoji: '🐘',
    tagName: '生態保育',
    tagName_en: 'Eco Sanctuary',
    intro: '主打「不騎乘、不強迫表演」的道德保育園區。若有長輩同行，特別推薦 SkyWalk 方案，可走在平緩的空中步道上遠距離觀察大象，低體力負擔且安全。註：園區位於市郊，此處為市區辦公室與接駁點。',
    intro_en: 'An ethical sanctuary famous for its "no riding, no performance" policy. The SkyWalk program is highly recommended for seniors, allowing observation from a flat, elevated walkway. (Sanctuary is located north; this is the city office/pickup point).',
    recommend: 'SkyWalk 觀察方案 / 一日保育體驗 (含接送與餐點)',
    recommend_en: 'SkyWalk Observation Program / Full Day Care Program (Incl. Transfer)',
    openTime: '07:00',
    closeTime: '18:00',
    hoursDisplay: '07:00 - 18:00 (無休)',
    hoursDisplay_en: '07:00 - 18:00 (Daily)',
    source: 'NotebookLM 推薦 / 道德保育首選',
    source_en: 'Recommended by NotebookLM'
  },
  {
    id: 'thai-akha-kitchen',
    name: 'Thai Akha Kitchen (阿卡族泰式廚藝教室)',
    name_en: 'Thai Akha Kitchen (Cooking Class)',
    category: 'sightseeing',
    lat: 18.7758,
    lng: 98.9868,
    emoji: '🍳',
    tagName: '廚藝教室',
    tagName_en: 'Cooking Class',
    intro: '由泰北少數民族阿卡族（Akha）經營的特色廚藝教室。包含傳統菜市場導覽採買教學，帶領旅客認識泰國辛香料，並親手烹飪客製化的經典泰北與阿卡族特色料理。',
    intro_en: 'A unique cooking school run by members of the hill tribe Akha people. Includes a local market tour to learn about Thai herbs and spices, and hands-on preparation of custom Lanna and Akha dishes.',
    recommend: '半日廚藝體驗 (親手做綠咖哩、冬蔭功與芒果糯米飯)',
    recommend_en: 'Half-day Cooking Experience (Green Curry, Tom Yum, Mango Sticky Rice)',
    openTime: '09:00',
    closeTime: '21:00',
    hoursDisplay: '09:00 - 21:00 (預約制)',
    hoursDisplay_en: '09:00 - 21:00 (Reservation Required)',
    source: 'NotebookLM 精選廚藝教室',
    source_en: 'Recommended by NotebookLM'
  },
  {
    id: 'asia-scenic-cooking',
    name: 'Asia Scenic Thai Cooking School (古城店)',
    name_en: 'Asia Scenic Thai Cooking School (Old City)',
    category: 'sightseeing',
    lat: 18.7897,
    lng: 98.9912,
    emoji: '🍳',
    tagName: '廚藝教室',
    tagName_en: 'Cooking Class',
    intro: '位於古城內的知名優質廚藝學校。擁有小型的草藥庭院，帶領學員親自去市場選購食材，能學習多款經典泰北咖哩、冬蔭功與涼拌木瓜沙拉的傳統製法。',
    intro_en: 'A highly rated cooking school in the Old City. Features an on-site organic herb garden. Includes a market tour and teaches traditional recipes for local curries, Tom Yum, and Papaya Salad.',
    recommend: '全天或半天課程 (含精美食譜書)',
    recommend_en: 'Full-day / Half-day Course (Includes recipe book)',
    openTime: '08:30',
    closeTime: '21:00',
    hoursDisplay: '08:30 - 21:00 (預約制)',
    hoursDisplay_en: '08:30 - 21:00 (Reservation Required)',
    source: 'NotebookLM 精選廚藝教室',
    source_en: 'Recommended by NotebookLM'
  }
];
